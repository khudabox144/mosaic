...
const PostActions = ({ postId, commentCount }) => {
    ...
    return (
        <div className="relative flex items-center justify-around py-4 lg:py-6 border-b border-gray-700">
            ...
            >
                <motion.button
                    ...
                    className="flex-center gap-2 text-xs font-semibold text-gray-400 lg:text-sm transition-all hover:text-white"
                >
                    <img src={LikeIcon} alt="Like" className="w-4" />
                    <span>Like</span>
                </motion.button>
